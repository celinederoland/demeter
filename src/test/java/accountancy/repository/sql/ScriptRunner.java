 ...
 */
@SuppressWarnings("ALL") public class ScriptRunner {
     ...
     */
    public ScriptRunner(
        java.sql.Connection connection, boolean autoCommit,
        boolean stopOnError
    ) {
     ...
     */
    private void runScript(java.sql.Connection conn, Reader reader) throws IOException,
        SQLException {
    ...
    private void execCommand(
        java.sql.Connection conn, StringBuffer command,
