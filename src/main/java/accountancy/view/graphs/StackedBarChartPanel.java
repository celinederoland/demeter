...
public class StackedBarChartPanel extends PPanel {

    public StackedBarChartPanel(LinkedHashMap<String, ArrayList<AmountByDate>> datas, ArrayList<Color> colors) {

        this.setMinimumSize(Dimensions.VIEW_FRAME_GRAPH);
        this.setPreferredSize(Dimensions.VIEW_FRAME_GRAPH);
        this.setLayout(new BorderLayout());
        JFreeChart lineChart = ChartFactory.createStackedBarChart(
            "Graph",
            "Date", "Montant",
            createDataset(datas),
