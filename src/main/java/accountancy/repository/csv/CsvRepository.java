...
public class CsvRepository {
    ...
    private final CsvImportRepository csvRepository;
    ...
    /**
     * Import a csv with minimum data (typically generated by external bank interface)
     *
    ...
    /**
     * Import a csv file formatted with all data (typically generated by equivalent application)
     *
     * @param iterator CSVIterator
     *
     * @throws ParseException if csv is not valid
